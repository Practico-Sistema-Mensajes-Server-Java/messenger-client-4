...
COPY --from=build /app/target/messenger-client-4-0.0.1-SNAPSHOT.jar /app/messenger-client-4.jar
...
ENTRYPOINT ["./wait-for-it.sh", "mysql-messenger-client-4:3306", "--", "java", "-jar", "/app/messenger-client-4.jar"]
